...
public class EventEntity {
    ...
    public EventEntity(Long eventExtId, Integer sequenceNr, String tenantId, EventDimension dimension, EventStatus status, String useCase, LocalDate date1, LocalDate date2) {
