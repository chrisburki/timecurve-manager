...
public class TimecurveObjectRepositoryImpl implements TimecurveObjectRepository {
    ...
    public TimecurveObjectRepositoryImpl(TimecurveObjectEntityRepository timecurveObjectEntityRepository, TimecurveObjectMapper timecurveObjectMapper/*, TimecurveObjectModelMapper timecurveObjectModelMapper*/) {
    ...
    public Optional<TimecurveObject> findById(Long id) {
        return timecurveObjectMapper.mapOptionalEntityToDomain(timecurveObjectEntityRepository.findById(id));
    }


    @Override
    public Optional<TimecurveObject> findByTag(String tag) {
        return timecurveObjectMapper.mapOptionalEntityToDomain(timecurveObjectEntityRepository.findByTag(tag));
    }

    @Override
    public List<TimecurveObject> findByName(String name) {
        return timecurveObjectMapper.mapEntityToDomainList(timecurveObjectEntityRepository.findByName(name));
    }

    @Override
    public TimecurveObject save(TimecurveObject timecurveObject) {
        return timecurveObjectMapper.mapEntityToDomain(timecurveObjectEntityRepository.save(timecurveObjectMapper.mapDomainToEntity(timecurveObject)));
    }

    @Override
    public void delete(TimecurveObject timecurveObject) {
        timecurveObjectEntityRepository.delete(timecurveObjectMapper.mapDomainToEntity(timecurveObject));
    }
