...
public class TimecurveManagerApplication {
	...
	public CommandLineRunner demo(TimecurveObjectRepository repository) {
		return (args) -> {
			...
			repository.save(new TimecurveObject(null,"AAA","share1chf","Share 1 CHF", TimecurveObjectValueType.CURRENCY,"CHF",null));
			repository.save(new TimecurveObject(null,"AAA","share2eur","Share 2 EUR", TimecurveObjectValueType.CURRENCY,"CHF",null));
			repository.save(new TimecurveObject(null,"AAA","bond1chf","Bond 1 CHF", TimecurveObjectValueType.CURRENCY,"CHF",null));
			repository.save(new TimecurveObject(null,"AAA","macc1eur","Money Account 1 CHF", TimecurveObjectValueType.CURRENCY,"CHF","CHF"));
			repository.save(new TimecurveObject(null,"AAA","macc2chf","Money Account 2 CHF", TimecurveObjectValueType.CURRENCY,"CHF","CHF"));
