...
public class EventItem {
    ...
    public EventItem(Long id, Event event, Integer rowNr, String tenantId, EventDimension dimension, Long timecurveId, EventItemType itemType, Long itemId, LocalDate date1, LocalDate date2, BigDecimal value1, BigDecimal value2, BigDecimal value3, BigDecimal tover1, BigDecimal tover2, BigDecimal tover3) {
        this.id = id;
        this.event = event;
        this.rowNr = rowNr;
