...
public class Event {
    ...
    public Event(Long id, Long eventExtId, Integer sequenceNr, String tenantId, EventDimension dimension, EventStatus status, String useCase, LocalDate date1, LocalDate date2, List<EventItem> eventItems) {
        this.id = id;
